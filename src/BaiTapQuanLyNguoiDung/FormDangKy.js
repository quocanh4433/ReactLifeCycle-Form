...
class FormDangKy extends Component {
    ...
    // CÁCH 2: khá chuối vì phải if else rất nhiều

    // Chạy trước render sau khi props hoặc sate thay đổi 

    // static getDerivedStateFromProps (newProps, currentState) {
    //     // Trường hợp bấm chỉnh sửa thì cần đổi state, còn trường hợp handle change input thì không cần gán props vào state nưa
    //     if (newProps.nguoiDungChinhSua.taiKhoan !== currentState.value.taiKhoan) {
    //         return {
    //             ...currentState,
    //             value: newProps.nguoiDungChinhSua
    //         }
    ...
    render() {
        let {taiKhoan, password, soDienThoai, email, hoTen, loaiNguoiDung} = this.state.value
        return (
